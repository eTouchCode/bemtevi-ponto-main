...
namespace StevenFox\LaravelSqids\Facades {
     ...
     */        class Sqidder {
         ...
         *
         * @static 
         */        public static function forConfig($name = null)
        {
                        /** @var \StevenFox\LaravelSqids\Sqidder $instance */
                        return $instance->forConfig($name);
        }
                    /**
         * 
         *
...
namespace  {
            ...
            class Sqidder extends \StevenFox\LaravelSqids\Facades\Sqidder {}
    }
