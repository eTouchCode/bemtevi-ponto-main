<x-layout bodyClass="bg-gray-200">
    <div class="mx-auto w-50 position-sticky z-index-sticky top-0">
        <div class="row">
            <div class="col-6">
                <!-- Navbar -->
                    ...
                    <div class="col-lg-6 col-md-8 col-12 mx-auto">
                        <div class="card z-index-0 fadeIn3 fadeInBottom">
                            ...
                            <div class="card-body">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div>
                                                @foreach ($tenants ?? [] as $tenant)
                                                    <a
                                                        href="{{ url(route('redirect-user-to-tenant', ['globalUserId' => auth()->user()->global_id, 'tenant' => $tenant])) }}">
                                                        {{ $tenant->getTenantKey() }}
                                                    </a>
                                                @endforeach
                                            </div>
                                ...
                                <form id="loginForm" role="form" method="POST" action="{{ route('central-login') }}"
                                    class="text-start">
                                    @csrf
