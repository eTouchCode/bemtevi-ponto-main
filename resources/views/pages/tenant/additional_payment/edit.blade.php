<x-layout bodyClass="g-sidenav-show  bg-gray-200">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        <x-navbars.navs.auth
            titlePage="{{ __('Editing :name', ['name' => __('Additional Payment')]) }}"></x-navbars.navs.auth>
        <!-- End Navbar -->
                        ...
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white mx-3">
                                    {{ __('Editing :name', ['name' => __('Additional Payment')]) }}
                                </h6>
                            </div>
                        </div>
                        <div class="card-body px-5 pb-5">
                            ...
                            <form role="form" method="POST" class="d-flex flex-column gap-2">
                                ...
                                <div class="form-row d-flex justify-content-start mt-5 gap-4">
                                    <div class="form-group col-6">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" name="percentageValue" type="checkbox"
                                                {{ $additional->percentageValue ? 'checked' : '' }}>
                                ...
                                <div class="form-row d-flex justify-content-start mt-2 gap-4">
                                    <div class="form-group col-6">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" id="fgtsToggle" name="fgts"
                                                type="checkbox" {{ $additional->fgts ? 'checked' : '' }} />
                                ...
                                <div class="form-row d-flex justify-content-start mt-2 gap-4">
                                    <div class="form-group col-6">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" id="inssToggle" name="inss"
                                                type="checkbox" {{ $additional->inss ? 'checked' : '' }}>
                                ...
                                <div class="form-row d-flex justify-content-start mt-2 gap-4">
                                    <div class="form-group col-6">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" id="irToggle" name="ir"
                                                type="checkbox" {{ $additional->ir ? 'checked' : '' }}>
                            ...
                            <div class="row justify-content-between">
                                <div class="col-3 pt-5 text-muted">
                                    <small>{{ __('Created At') }}
                                        {{ \Carbon\Carbon::parse($additional->created_at)->format('d/m/Y H:i:s') }}
                                    </small>
                                    <br>
                                    <small>{{ __('Last Updated') }}
                                        {{ \Carbon\Carbon::parse($additional->updated_at)->format('d/m/Y H:i:s') }}
                                    </small>
                                </div>
                            </div>
                        </div>
