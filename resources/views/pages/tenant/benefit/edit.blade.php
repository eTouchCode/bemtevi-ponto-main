<x-layout bodyClass="g-sidenav-show  bg-gray-200">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        <x-navbars.navs.auth titlePage="{{__('Editing :name', ['name' => __('Benefit')])}}"></x-navbars.navs.auth>
        <!-- End Navbar -->
                        ...
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white mx-3">
                                    {{__('Editing :name', ['name' => __('Benefit')])}}
                                </h6>
                            </div>
                        </div>
                        <div class="card-body px-5 pb-5">
                                    ...
                                    <div class="form-group col-6">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" name="percentageValue" type="checkbox"
                                                id="percentageToggle" {{$benefit->percentageValue ? "checked" : ""}}>
                            ...
                            <div class="row justify-content-between">
                                <div class="col-3 pt-5 text-muted">
                                    <small>{{__("Created At")}}
                                        {{\Carbon\Carbon::parse($benefit->created_at)->format('d/m/Y H:i:s')}}
                                    </small>
                                    <br>
                                    <small>{{__("Last Updated")}}
                                        {{\Carbon\Carbon::parse($benefit->updated_at)->format('d/m/Y H:i:s')}}
                                    </small>
                                </div>
                            </div>
                        </div>
