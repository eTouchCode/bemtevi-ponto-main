                        ...
                        <div class="card-body px-5 pb-5">
                                    ...
                                    <div class="form-group col-6">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" name="status" type="checkbox"
                                                id="statusToggle" {{$camera->status ? 'checked' : ''}}>
                                ...
                                <div class="form-row d-flex justify-content-between  gap-4 my-4">
                                    <div class="from-group col-3">
                                        <div class="input-group input-group-dynamic mt-3 is-filled">
                                            ...
                                            <input type="text" class="form-control" name="ip" value="{{$camera->ip}}">
                                        </div>
                                        @error('port')
                                            <p class='text-danger inputerror'>{{ $message }} </p>
                                        @enderror
                                    ...
                                    <div class="from-group col-3">
                                        <div class="input-group input-group-dynamic mt-3 is-filled">
                                            ...
                                            <select name="location" class="form-control">
                                                ...
                                                <option value="entrance" {{$camera->location == "entrance" ? "selected" : '' }}>{{__("Entrance")}}</option>
                                                <option value="exit" {{$camera->location == "exit" ? "selected" : ''}}>
                                                    {{__('Exit')}}
                                                </option>
                                            </select>
                                        </div>
                                ...
                                <div class="form-row d-flex justify-content-start gap-4">
                                    <div class="form-group col-12">
                                        <div class="input-group input-group-dynamic mt-3 is-filled">
                                            ...
                                            <input id="rtsp" type="text" class="form-control" name="address" value="">
                                        </div>
                                        @error('address')
                                            <p class='text-danger inputerror'>{{ $message }} </p>
                                        @enderror
                            ...
                            <div class="row justify-content-between">
                                <div class="col-3 pt-5 text-muted">
                                    <small>{{__("Created At")}}
                                        {{\Carbon\Carbon::parse($camera->created_at)->format('d/m/Y H:i:s')}}
                                    </small>
                                    <br>
                                    <small>{{__("Last Updated")}}
                                        {{\Carbon\Carbon::parse($camera->updated_at)->format('d/m/Y H:i:s')}}
                                    </small>
                                </div>
                            </div>
                        </div>
