                                        ...
                                        <div class="input-group input-group-static mb-4">
                                            ...
                                            <select class="form-control" name="warningType">
                                                ...
                                                <option value="success"
                                                    {{ $warning->warningType == 'success' ? 'selected' : '' }}
                                                    class="text-success">Success</option>
                                                <option value="warning"
                                                    {{ $warning->warningType == 'warning' ? 'selected' : '' }}>Warning
                                                </option>
                                                <option value="info"
                                                    {{ $warning->warningType == 'info' ? 'selected' : '' }}>Info
                                                </option>
                                                <option value="danger"
                                                    {{ $warning->warningType == 'danger' ? 'selected' : '' }}>Danger
                                                </option>
                                                <option value="primary"
                                                    {{ $warning->warningType == 'primary' ? 'selected' : '' }}>Primary
                                                </option>
                                                <option value="secondary"
                                                    {{ $warning->warningType == 'secondary' ? 'selected' : '' }}>
                                                    Secondary</option>
                                            </select>
                                        </div>
                                        @error('warningType')
                                ...
                                <div class="form-row d-flex justify-content-start gap-4">
                                    <div class="form-group col-6">
                                        <div class="input-group input-group-dynamic">
                                            <textarea class="form-control" name="message" rows="2" placeholder="{{ _('Message') }}" spellcheck="false">{{ $warning->message }}</textarea>
                                        </div>
                                        @error('message')
                                            <p class='text-danger inputerror'>{{ $message }} </p>
                                        @enderror
                                        ...
                                        <div class="input-group input-group-static mb-4">
                                            ...
                                            <select class="form-control">
                                                ...
                                                <option value="company"
                                                    {{ $warning->target == 'company' ? 'selected' : '' }}>Todos
                                                </option>
                                                <option value="admins"
                                                    {{ $warning->target == 'admins' ? 'selected' : '' }}>Todos
                                                    >Administradores</option>
                                                <option value="employees"
                                                    {{ $warning->target == 'employees' ? 'selected' : '' }}>Todos
                                                    >Funcionários</option>
                                            </select>
                                        </div>
                                        @error('target')
                                                ...
                                                <div class="input-group input-group-static mb-4">
                                                    ...
                                                    <select id="iconSelect" class="form-control" name="icon">
                                                        @foreach ($icons as $icon)
                                                            <option {{ $icon == $warning->icon ? 'selected' : '' }}
                                                                value="{{ $icon }}">{{ $icon }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-6">
                                                <div class="h-100 d-flex flex-row align-items-center gap-5">
                                                    ...
                                                    <span id="previewIcon"><i
                                                            class="material-icons">{{ $warning->icon ?? $icons[0] }}</i></span>
                                                </div>
