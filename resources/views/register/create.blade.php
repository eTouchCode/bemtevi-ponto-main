                        ...
                        <div class="row">
                            ...
                            <div
                                ...
                                <div class="card card-plain">
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="{{route('central.createCompany')}}">
                                            @csrf
                                            ...
                                            @enderror
                                            <div class="input-group input-group-outline mt-3">
                                                <label class="form-label">Company CNPJ</label>
                                                <input type="text" class="form-control" name="companyCNPJ"
                                                    value="{{ old('companyCNPJ') }}">
                                            </div>
                                            @error('companyCNPJ')
                                                <p class='text-danger inputerror'>{{ $message }} </p>
                                            @enderror
                                            ...
                                            <div class="input-group input-group-outline mt-3">
                                                ...
                                                <input type="text" class="form-control" name="companyDomain"
                                                    value="{{ old('companyDomain') }}">
                                            </div>
                                            @error('companyDomain')
                                                <p class='text-danger inputerror'>{{ $message }} </p>
                                            @enderror
